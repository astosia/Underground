...
static char* weather_conditions[] = {
  ...
  "\U0000F01A", // 'nt_shower rain': 14,
  "\U0000F019", // 'nt_rain': 15,
  "\U0000F076", // 'nt_snow': 16,
  "\U0000F02C", // 'nt_tstorms': 17,
  "\U0000F04A", // 'nt_mist': 18,
  "\U0000F014", // 'fog': 19,
  "\U0000F01C", // 'drizzle': 20,
  "\U0000F018", // 'violent driving rain': 21,
  "\U0000F0B5", // 'sleet': 22,
  "\U0000F017", // 'heavy sleet': 23,
  "\U0000F01B", // 'slight snow': 24,
  "\U0000F015", // 'hail': 25,
  "\U0000F068", // 'thunderstorn with hail day': 26,
  "\U0000F019", // 'heavy rain': 27,
  "\U0000F06A", // 'thunderstorn with hail night': 28,
};
